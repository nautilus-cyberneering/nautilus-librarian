...
from nautilus_librarian.mods.dvc.domain.utils import (
    ...
    extract_list_of_media_file_changes_from_dvd_diff_output,
)


def test_extract_list_of_media_file_changes_from_dvd_diff_output():
    dvc_diff = {
        "added": [
    ...
    filenames = extract_list_of_media_file_changes_from_dvd_diff_output(
