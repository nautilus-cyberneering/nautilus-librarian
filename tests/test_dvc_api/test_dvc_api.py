...
def test_list():
    ...
    add_remote_to_scenario()
    dvcapi.push(get_test_dir())
    expected_list_output = [{'isout': False, 'isdir': False, 'isexec': False, 'path': '.dvcignore'}, {'isout': False, 'isdir': False, 'isexec': False, 'path': '.gitignore'}, {'isout': True, 'isdir': False, 'isexec': False, 'path': 'test.data'}, {'isout': False, 'isdir': False, 'isexec': False, 'path': 'test.data.dvc'}]
